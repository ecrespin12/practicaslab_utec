          ...
          <div class="x_content">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal-encargado" ><span class="fa fa-plus"></span> Agregar Encargado</button> 
              </div>
            </div>
            <hr>
...
<!-- /page content -->
    ...
    <!-- /.modal -->
        ...
        <!-- modal form -->
        <div class="modal fade" id="modal-encargado-editar">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form name="frm" action="" method="POST">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12 col-xs-12">
                          <label>DUI</label>
                          <input type="text" class="form-control col-md-7 col-xs-12" name="dui" placeholder="Ingresar DUI" required="">
                        </div>
                        <div class="form-group col-md-6 col-sm-12 col-xs-12">
                          <label>Celular</label>
                          <input type="text" class="form-control col-md-7 col-xs-12" name="celular" placeholder="Ingresar Celular" required="">
