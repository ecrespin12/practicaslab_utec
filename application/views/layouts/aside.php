           ...
           <div class="menu_section">
             <ul class="nav side-menu">
              <li><a href="<?php echo base_url();?>Dashboard"><i class="fa fa-home"></i> Inicio</a></li>
               <li><a href="<?php echo base_url();?>estudiante/Practica"><i class="fa fa-calendar"></i> Practicas</a></li>
               <li><a href="<?php echo base_url();?>Dashboard"><i class="fa fa-sign-out"></i> Cerrar Sesión</a></li>
